    ...
    <section id='technical-skills' className='technical-skills'>
      <div className='container'>
        ...
        <div className='dev-logos-container'>
          ...
          <div id="typescript-logo" className="dev-logos" rel="noopener noreferrer" >
            <a href='https://www.typescriptlang.org/'>
              <img src='https://cdn.svgporn.com/logos/typescript.svg' alt='typescript'/>
              <h6>TYPESCRIPT</h6>
            </a>
          </div>
          <div id="python-logo" className="dev-logos" rel="noopener noreferrer">
            <a href='https://www.python.org/'>
              <img src='https://cdn.svgporn.com/logos/python.svg' alt='python'/>
              <h6>PYTHON</h6>
            </a>
          </div>
          <div id="java-logo" className="dev-logos" rel="noopener noreferrer">
            <a href='https://www.java.com/en/'>
              <img src='https://cdn.svgporn.com/logos/java.svg' alt='java'/>
              <h6>JAVA</h6>
            </a>
          </div>
          <div id="springBoot-logo" className='dev-logos' rel="noopener noreferrer">
            <a href='https://spring.io/projects/spring-boot' target='_blank' rel="noopener noreferrer">
              <img src='https://cdn.svgporn.com/logos/spring.svg' alt='springBoot'/>
              <h6>SPRING BOOT</h6>
            </a>
          </div>
          <div id="nodejs-logo" className="dev-logos" rel="noopener noreferrer">
            <a href='https://nodejs.org/en'>
              <img src='https://cdn.svgporn.com/logos/nodejs.svg' alt='nodejs'/>
              <h6>NODEJS</h6>
            </a>
          </div>
          <div id="express-logo" className="dev-logos" rel="noopener noreferrer">
            <a href='https://expressjs.com/'>
              <img src='https://cdn.svgporn.com/logos/express.svg' alt='express'/>
              <h6>EXPRESS</h6>
            </a>
          </div>
          <div id="react-logo" className='dev-logos' rel="noopener noreferrer">
            <a href='https://reactjs.org/'>
              <img src='https://cdn.svgporn.com/logos/react.svg' alt='react'/>
              <h6>REACT</h6>
            </a>
          </div>
          <div id="redux-logo" className='dev-logos' rel="noopener noreferrer">
            <a href='https://redux.js.org/'>
              <img src='https://cdn.svgporn.com/logos/redux.svg' alt='redux'/>
              <h6>REDUX</h6>
            </a>
          </div>
          <div id="angular-logo" className='dev-logos'>
          ...
          <div id="html5-logo" className='dev-logos' rel="noopener noreferrer">
            <a href='https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5'>
              <img src='https://cdn.svgporn.com/logos/html-5.svg' alt='html5'/>
              <h6>HTML5</h6>
            </a>
          </div>
          <div id="css3-logo" className='dev-logos' rel="noopener noreferrer">
